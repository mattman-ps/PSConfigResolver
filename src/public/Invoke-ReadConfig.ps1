function Invoke-ReadConfig {
    ...
    .EXAMPLE
        $config = Invoke-ReadConfig -ConfigFilePath ".\sample.json"
        
    .EXAMPLE
        $config = Invoke-ReadConfig -ConfigFilePath ".\sample.xml" -Test
        
    .EXAMPLE
        Invoke-ReadConfig -ConfigFilePath "C:\Config\settings.json" -Test
    #>
    [CmdletBinding()]
    param(
